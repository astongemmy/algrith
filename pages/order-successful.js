      ...
      <main>
        <section className="h-screen w-full 2xl:w-9/12 2xl:mx-auto p-8">
          <div className="h-full flex flex-col justify-center items-center mx-auto w-full md:w-6/12 lg:w-5/12 xl:w-3/12">
            <div className="shadow rounded-2xl dark:bg-slate-800 bg-white w-full pt-10 pb-10 px-6">
              ...
              <div className="pt-5 text-center">
                ...
                <Link href={'/'}>
                  <a className="text-md font-medium text-heading px-2 py-1 mt-5 block text-white dark:bg-opacity-50 bg-green-500 shadow-sm rounded-full">
                    Back to homepage
                  </a>
                </Link>
              </div>
