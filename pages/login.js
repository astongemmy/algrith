          ...
          <div className="h-full flex flex-col justify-center items-center mx-auto w-full md:w-6/12 lg:w-5/12 xl:w-3/12">
            <div className="shadow rounded-2xl bg-white w-full pt-4 pb-12 px-6">
              <div className="flex justify-between items-center">
                ...
                <h1 className="text-xl font-medium text-heading -mt-2 px-4 py-2 text-white bg-green-500 shadow-sm rounded-full">Login</h1>
              </div>
              <form onSubmit={Login} className="w-full px-1 mt-4">
                ...
                <Link href={'/recover-password'}>
                  <a className="text-lg text-center my-4 block text-gray-600">Recover password?</a>
                </Link>
              ...
              <p className="text-xl text-center mt-4">
                ...
                <Link href={'/signup'}>
                  <a className="block text-black font-bold">Sign up</a>
                </Link>
              </p>
            </div>
          </div>
