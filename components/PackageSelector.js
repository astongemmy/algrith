...
export default function PackageSelector({ type, selectedPackage, getSelected, mobile }) {
  return (
    <div className={`${mobile && 'md:hidden my-8'} ${!mobile && 'hidden md:block xl:w-3/6'} overflow-hidden dark:bg-slate-800 bg-white border dark:border-gray-500 rounded-2xl pb-8`}>
      ...
      <div className="px-6">
        ...
        <h2 className="my-2 text-3xl md:text-3xl dark:text-gray-200 text-gray-600 font-heading font-medium">
