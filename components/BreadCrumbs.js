  ...
  return (
    <div className="w-full">
      <ul className="flex flex-wrap items-center mb-4 md:mb-8">
        <li className="mr-6">
          <Link href="/">
            <a className="flex items-center text-lg font-medium text-gray-500 hover:text-gray-500">
              <span>Home</span>
          ...
          return (
            <li key={ breadcrumb.url } className="mr-6">
              <Link href={ breadcrumb.url }>
                <a className="flex items-center text-lg font-medium text-gray-500 hover:text-gray-500" href="#">
