      ...
      <div className="2xl:w-8/12 2xl:mx-auto">
        <div className="max-w-7xl mx-auto px-8 sm:px-6 md:px-12 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-xl dark:text-teal-400 text-indigo-600 font-bold tracking-wide uppercase">
            ...
            <p className="mt-4 max-w-4xl leading-9 text-xl font-montserrat font-semibold dark:text-slate-300 text-gray-500 lg:mx-auto">
