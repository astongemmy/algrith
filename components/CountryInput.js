...
const CountryInput = ({ defaultValue, updateValue, required, label, id }) => {
  ...
  return (
    <>
      <label htmlFor={id} className="block text-lg font-medium dark:text-gray-200 text-gray-700">
        {label} {required && (<span className="text-xl text-red-400">*</span>)}
      </label>
