...
export default function Pricing({ packages, slug }) {
  return (
    <section className="w-full pt-16 pb-24 2xl:py-40 bg-gray-800">
            ...
            {packages.map((item) => {
              return (
                <div key={ item.id } className="relative w-full md:w-1/3 px-3 mb-8 lg:mb-0">
                  <div className={`${item.active ? 'bg-orange-500' : 'bg-navyBlue-500 border'} px-12 md:px-4 lg:px-8 xl:px-12 py-16 md:py-6 lg:py-16 rounded-3xl`}>
