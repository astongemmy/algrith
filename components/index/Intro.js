...
export default class Intro extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="relative flex flex-wrap xl:flex-nowrap justify-around items-center w-screen dark:bg-black bg-intro bg-left-top bg-contain xl:bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
