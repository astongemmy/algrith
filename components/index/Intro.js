...
export default class Intro extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="relative flex flex-wrap xl:flex-nowrap justify-around items-center w-full dark:bg-black bg-intro bg-left-top bg-cover xl:bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
