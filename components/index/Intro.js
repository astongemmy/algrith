    ...
    render() {
        ...
        return (
            ...
            <div className="flex flex-wrap xl:flex-nowrap justify-around items-center bg-green-300 p-16 w-full dark:bg-black">
                ...
                <div className="w-full xl:w-2/3 text-yellow-200 m-0 md:m-4 p-4 lg:p-16 text-5xl lg:text-8xl">
                    "The best software algorithm solution"
                </div>

                <div className="relative w-full xl:w-1/3 m-0 md:m-4 p-2 lg:p-16">                    
