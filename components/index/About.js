    ...
    render() {
        ...
        return (
            ...
            <div className="relative py-16 px-1 lg:px-32 w-full dark:bg-black">
                ...
                <div className="bg-gray-200 relative w-3/4 lg:w-auto mb-8 lg:mb-0 mx-auto lg:absolute lg:-top-28 lg:-left-28 rounded-full overflow-hidden p-0 lg:p-8 transform lg:scale-65 animation-all duration-1000 ease-in-out">
