...
<div className="absolute left-2/4 top-2/4 transform -translate-x-2/4 -translate-y-2/4 overflow-hidden flex justify-start lg:justify-center w-full m-0 py-2 lg:p-12 bg-gradient-to-r from-red-400 via-transparent via-transparent to-red-400">
                            <img src="./images/illustrations/man-on-laptop.png" alt="contact us section image" />
                        </div>
<div className="relative">
<div className="text-4xl p-4 text-white rounded-t-xl bg-gradient-to-b from-red-400 via-red-400">
Want to talk to us about anything?
</div>
<ul className="text-xl text-white text-shadow p-4">
