...
<label className="text-gray-600 text-2xl py-2" for="contact-us-email">Email</label>
                            ...
                            <div className="w-full lg:w-2/4 p-4">
<label className="text-gray-600 text-2xl py-2" for="contact-us-name">Full Name</label>
                            ...
                            <div className="w-full lg:w-2/4 p-4">
<label className="text-gray-600 text-2xl py-2" for="contact-us-phone">Phone</label>
                            ...
                            <div className="w-full lg:w-2/4 p-4">
<label className="text-gray-600 text-2xl py-2" for="contact-us-location">Location</label>
...
<label className="text-gray-600 text-2xl py-2" for="contact-us-message">Message</label>
