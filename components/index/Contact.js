...
<div className="text-3xl p-8 text-purple-500 rounded-t-xl bg-gradient-to-b from-red-400 via-red-400">
...
<div className="text-white text-xl py-8 px-4 text-center bg-gradient-to-t from-purple-400 rounded-b-xl">
