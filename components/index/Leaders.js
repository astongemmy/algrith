    ...
    render() {
        ...
        return (
            ...
            <div className="relative overflow-x-hidde py-16 px-2 lg:px-32 w-full bg-green-400 dark:bg-black">
                ...
                <h1 className="relative uppercase text-3xl md:text-5xl text-white mx-auto w-full text-center font-medium">
                    The company
                </h1>

                <div className="relative z-10 flex flex-wrap justify-around items-center mt-12 lg:mt-0 px-2 xl:px-64 py-0 lg:py-16 w-full">

                    <div className="relative w-full shadow-2xl lg:w-80 bg-red-200 rounded-xl my-4 mx-8 md:mx-0 p-0 md:p-4">

                        <div className="relative w-full m-0 rounded-xl">

                            <div className="flex relative mx-auto my-8 w-52 h-52 rounded-full ring-8 ring-red-200 shadow-2xl ring-offset-4 ring-offset-gray-100">
                            ...
                            <div className="relative my-2 uppercase text-center shadow-2xl bg-red-200 text-red-600 p-4 rounded-xl">
                                Co Founder
                            </div>

                            <div className="relative my-2 uppercase text-center shadow-2xl text-red-600 font-bold py-2 px-4 rounded-xl">
                                Ilori, OluJide
                            </div>
                    ...
                    <div className="relative shadow-2xl w-full lg:w-80 bg-green-200 rounded-xl my-4 mx-8 md:mx-0 p-0 md:p-4">
                    ...
                    <div className="relative shadow-2xl w-full lg:w-80 bg-red-200 rounded-xl my-4 mx-8 md:mx-0 p-0 md:p-4">

                        <div className="relative w-full m-0 rounded-xl">
                        
                            <div className="flex relative mx-auto my-8 w-52 h-52 rounded-full shadow-2xl ring-8 ring-red-200 ring-offset-4 ring-offset-gray-100">
                                <div className="relative flex justify-center items-center w-full h-full rounded-full overflow-hidden">
