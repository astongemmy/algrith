    ...
    render() {
        ...
        return (
            ...
            <div className="relative overflow-x-hidde py-16 px-2 lg:px-32 w-full bg-green-400 dark:bg-black">
                ...
                <h1 className="relative uppercase text-3xl py-4 md:text-4xl text-white mx-auto w-full text-center font-bold">
                    The company
                </h1>

                <div className="relative z-10 flex flex-wrap justify-around items-center mt-12 lg:mt-0 px-2 xl:px-64 py-0 lg:py-16 w-full">

                    <div className="relative w-full shadow-2xl lg:w-80 bg-gradient-to-b from-green-500 via-transparent to-green-200 rounded-xl my-4 mx-8 md:mx-0 px-0 md:p-4">
                    ...
                    <div className="relative shadow-2xl w-full lg:w-80 bg-gradient-to-b from-green-400 via-transparent to-green-500 rounded-xl my-4 mx-8 md:mx-0 px-0 md:p-4">
                    ...
                    <div className="relative shadow-2xl w-full lg:w-80 bg-gradient-to-b from-green-500 via-transparent to-green-200 rounded-xl my-4 mx-8 md:mx-0 px-0 md:p-4">
