    ...
    render() {
        ...
        return (
            ...
            <div className="relative overflow-hidden py-16 px-2 lg:px-32 w-full bg-gray-100 dark:bg-black">
                ...
                <div className="relative flex justify-center items-center w-3/4 lg:w-auto mb-8 lg:mb-0 mx-auto lg:absolute lg:-top-72 lg:-right-80 rounded-full overflow-hidden lg:p-8 transform lg:scale-65 animation-all duration-1000 ease-in-out">
                ...
                <div className="relative flex flex-wrap justify-around items-center mt-12 lg:mt-0 px-2 xl:px-64 py-0 lg:py-16 w-full">
                    ...
                    <div className="relative w-full lg:w-2/4 xl:w-2/4 my-0 mx-4 md:mx-0 p-0 md:p-4">
                        ...
                        <div className="relative w-full m-0 p-4 lg:p-12">
                            ...
                            <div className="absolute top-4 left-52 bg-red-400 transform rotate-45 w-4 h-32 border-t-4 border-r-4 border-red-600 rounded-xl"></div>
                    ...
                    <div className="relative w-full lg:w-2/4 xl:w-2/4 my-0 mx-4 md:mx-0 p-0 md:p-4">
                        ...
                        <div className="relative w-full m-0 p-4 lg:p-12">
                            ...
                            <div className="absolute top-4 right-52 bg-red-400 transform -rotate-45 w-4 h-32 border-t-4 border-r-4 border-red-600 rounded-xl"></div>
