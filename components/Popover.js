    ...
    {toggle == true && <div id="popover" className="transition duration-150 ease-in-out absolute top-8 left-0 w-full sm:w-auto z-10">
      <div className="dark:bg-slate-800 bg-white rounded shadow-2xl w-auto">
        ...
        {/* <svg className="absolute -ml-5 -mb-10 left-0 bottom-0" width="30px" height="30px" viewBox="0 0 9 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"> */}
          ...
          <Link href="/products" className="text-lg dark:text-green-300 text-gray-800 font-normal leading-normal tracking-normal">
            <i className="fa fa-list mr-6"></i>All products
          </Link>
        ...
        <div className="w-full h-full px-8 pt-3 pb-5">
          <ul className="w-full">
            {items.map((anchor) => {
              return (
                <li key={ anchor.href }>                    
                  <Link href={ anchor.href } className="flex items-center py-4 w-full min-w-max dark:text-green-300 text-gray-600 font-normal text-lg">
