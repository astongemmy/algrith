...
export default function Footer() {
	return (
		<footer className="relative dark:bg-slate-700 bg-gray-100">
			<div className="flex flex-wrap justify-between px-4 md:px-8 lg:px-16 xl:px-24 pb-12">
				<div className="w-full md:w-2/5 lg:w-3/12 pt-8">
					<h1 className="p-4 dark:text-gray-400 text-navyblue text-xl font-bold">
					...
					<div className="relative px-4 text-lg">
						<details className="my-4 rounded-xl dark:bg-slate-500 bg-white shadow-lg border-gray-200 cursor-pointer">
							<summary className="flex justify-between items-center p-4 dark:text-gray-300 text-black focus:outline-none hover:outline-none outline-none transition-all ease-in-out duration-700">
								<span className="ml-4">Data for scientists</span>
								<i className="fa fa-bug mr-4"></i>
							</summary>
							<p className="px-8 pt-2 pb-6 dark:text-gray-200 text-gray-600 transition-all ease-in-out duration-700">
				...
				<div className="flex flex-wrap justify-between w-full md:w-3/5 lg:w-9/12 pt-4 md:pl-4">
					<div className="w-1/2 lg:w-1/4 pt-4">
						<h1 className="p-4 dark:text-gray-400 text-navyblue font-bold text-xl">
							<svg xmlns="http://www.w3.org/2000/svg" className="inline mr-4 text-green-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
