...
export default class Pricing extends React.Component {
  ...
  render() {
    return (
      <section className="w-full pt-20 pb-24 2xl:py-40 bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-wrap items-center -mx-3 px-4">
              <div className="w-full md:w-1/3 px-3 mb-8 lg:mb-0">
                <div className="px-12 md:px-4 lg:px-12 py-16 md:py-6 lg:py-16 bg-gray-500 rounded-3xl">
              ...
              <div className="w-full md:w-1/3 px-3 mb-8 lg:mb-0">
                <div className="px-12 md:px-4 lg:px-12 py-16 md:py-6 lg:py-16 bg-blue-500 rounded-3xl">
