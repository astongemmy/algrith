      ...
      <div className="relative overflow-hidden">
        <div className="md:flex justify-between relative mx-auto px-4 sm:px-6 lg:px-0 sm:static">
          <div className="lg:pr-28 xl:pr-32 px-2 md:px-auto">
            ...
            <Link href="/products">
              <a className="mt-6 md:mt-8 lg:mt-10 inline-block text-center bg-teal-500 border border-transparent rounded-md py-4 px-8 text-2xl text-white hover:bg-indigo-700">
                Order Now
