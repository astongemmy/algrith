...
export default function GetStarted() {
  return (
    <div className="relative pb-10 md:pb-24 px-8 md:px-12 lg:px-20 xl:px-32 w-full">
          ...
          <div className="md:flex justify-between relative mx-auto px-4 sm:px-6 lg:px-8 sm:static">
            ...
            <div className="sm:max-w-2xl px-2 md:px-auto">
              ...
              <Link href="/products/websites">
                <a className="mt-6 md:mt-8 lg:mt-10 md:ml-auto inline-block text-center bg-indigo-600 border dark:bg-opacity-50 border-transparent rounded-md py-4 px-8 text-2xl text-white hover:bg-indigo-700">
                  Get Started 
