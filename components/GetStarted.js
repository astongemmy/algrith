          ...
          <div className="md:flex justify-between relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
            ...
            <div className="sm:max-w-2xl px-2 md:px-auto">
              ...
              <Link href="/products/websites">
                <a className="mt-6 md:mt-8 lg:mt-10 md:ml-auto inline-block text-center bg-indigo-600 border border-transparent rounded-md py-4 px-8 text-2xl text-white hover:bg-indigo-700">
                  Get Started 
