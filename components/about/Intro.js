        ...
        return (
            ...
            <div className="relative w-full dark:bg-black bg-intro-about bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
                ...
                <div className="w-full bg-gradient-to-b from-white p-8 lg:p-20">
                    <h1 className="relative uppercase text-3xl md:text-8xl text-green-500 py-8 m-0 w-full text-left font-bold">
                        Who we really are!
                    </h1>
                    <p className="w-full text-left text-gray-600 text-2xl lg:text-5xl">
                ...
                <a href="#outline" name="scroll-down" className="scroll-selector cursor-pointer absolute flex justify-center items-center right-12 lg:right-32 -bottom-8 rounded-full bg-green-400 text-white p-8 text-3xl w-20 h-20"><i className="fa fa-arrow-down"></i></a>
