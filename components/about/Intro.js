        ...
        return (
            ...
            <div className="relative w-full dark:bg-black bg-intro-about bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
                ...
                <div className="w-full rounded-xl shadow-xl m-0 md:m-4 p-8 lg:p-20">
                    ...
                    <p className="w-full text-center text-white text-3xl lg:text-5xl text-shadow">
                ...
                <a href="#outline" className="scroll-selector cursor-pointer absolute flex justify-center items-center right-32 -bottom-8 rounded-full bg-green-600 text-white p-8 text-3xl w-20 h-20"><i className="fa fa-arrow-down"></i></a>
