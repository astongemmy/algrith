    ...
    render() {
        ...
        return (
            ...
            <div id="intro-about" className="relative w-full dark:bg-black bg-intro-about bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
                ...
                <div className="w-full bg-gradient-to-b from-white p-8 lg:py-20 lg:px-24">
                    <h1 data-aos="fade-down" className="intro-lead relative uppercase text-3xl md:text-8xl text-green-500 py-8 m-0 w-full text-left font-bold"></h1>
