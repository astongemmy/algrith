        ...
        return (
            <div id="intro-about" className="relative w-full dark:bg-black bg-intro-about bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">                
                <div className="w-full bg-gradient-to-b from-white pt-0 lg:pt-12 pb-12 lg:pb-20 px-8 md:px-12 lg:px-18 xl:px-24">
                    ...
                    <p data-aos="fade-up" className="w-full text-left text-gray-600 text-2xl lg:text-3xl">
                    ...
                    <aside data-aos="fade-right" className="mt-4 md:mt-8 text-navyblue text-xl font-bold lg:text-3xl">
                        We make happy clients
                    </aside>
                </div>
                <span href="#outline" className="scroll-selector cursor-pointer absolute flex justify-center items-center right-8 md:right-12 lg:right-32 -bottom-8 rounded-full bg-green-400 text-white p-8 text-3xl w-16 h-16 md:w-18 md:h-18 z-10">
