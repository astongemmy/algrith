...
export default function WishlistButton() {
  return (
    <div className="w-full lg:w-1/3 lg:pl-2">
      <a className="bg-red-100 flex w-full py-4 px-2 items-center justify-center leading-8 font-heading font-semibold tracking-tighter text-xl text-center bg-white focus:ring-2 focus:ring-gray-200 focus:ring-opacity-50 hover:bg-opacity-60 rounded-xl" href="#">
