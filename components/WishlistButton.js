...
export default function WishlistButton() {
  return (
    <div className="w-full lg:w-1/3 lg:pl-2">
      <a className="bg-red-100 text-gray-400 flex w-full py-3 px-2 items-center justify-center leading-8 font-heading font-medium tracking-wider text-xl text-center focus:ring-2 focus:ring-gray-200 focus:ring-opacity-50 hover:bg-opacity-60 rounded-xl" href="#">
