...
const Header = ({ openMenuRef }) => {
    ...
    <header id="header" className="flex sticky top-0 z-20 justify-between items-center bg-white px-6 md:px-12 lg:px-16 xl:px-28 py-1 w-full dark:bg-dark-mode-primary">
          ...
          href="/">
			...
			<button type="button" ref={ openMenuRef } className="lg:hidden flex justify-center items-center text-3xl p-4 -mr-3 text-gray-600 dark:text-theme-primary bg:transparent outline-none focus:outline-none border-none transform scale-y-75 transition-all ease-in-out duration-1000">
