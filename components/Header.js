...
export default function Header({ openMenuRef }) {
	return (
		<header id="header" className="flex sticky top-0 z-20 justify-between items-center bg-white bg-geen-300 px-6 md:px-12 lg:px-16 xl:px-28 py-1 md:py-6 w-full dark:bg-black">
