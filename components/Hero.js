...
export default function Hero({ products }) {
  ...
  return (
    <div id="product-intro" className="w-full pt-10 lg:py-16 dark:bg-slate-800 bg-white">
      <div className="max-w-7xl mx-auto px-8 sm:px-6 md:px-12 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-2 text-5xl leading-tight sm:leading-tight font-extrabold tracking-tight dark:text-gray-200 text-gray-900 sm:text-5xl">
            Order for a landing page design, corporate website design or even an e-commerce website.
          </p>
          <p className="mt-4 max-w-4xl leading-9 text-xl dark:text-gray-400 text-gray-500 lg:mx-auto">
      ...
      <div className="w-full mx-auto py-6 sm:py-10 px-4 md:px-8 sm:px-6 md:px-10 lg:px-14 xl:px-28">
        <Carousel sliderClass="mt-6" itemClass="px-4" containerClass="pb-8 flex justify-between" responsive={responsive}>
          {products.map((product) => (
            <div key={product.package.id} className="rounded-lg overflow-hidden dark:shadow-gray-700 shadow-lg group relative">
              ...
              <div className="mt-4 flex justify-between px-4 pb-4">
                <div>
                  <h3 className="text-lg dark:text-slate-400 text-gray-800 font-bold">
