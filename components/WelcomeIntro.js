		...
		<div id="intro-index" className="relative w-full h-auto xl:h-126 bg-intro-index bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
			<div className="h-full w-full relative px-4 md:px-3 lg:px-9 2xl:px-0 flex flex-wrap xl:flex-nowrap justify-around xl:justify-start items-center bg-gradient-to-b dark:from-slate-900 from-white">
				<div className="relative w-full 2xl:w-8/12 2xl:mx-auto h-full">
					<div data-aos="fade" className="relative w-full xl:w-3/5 text-green-500 dark:text-navyblue m-0 px-2 md:px-10 py-8 lg:pr-0 lg:p-10 xl:p-20 2xl:px-0 2xl:py-20">
					...
					<div className="relative xl:absolute xl:right-20 xl:top-0 w-full xl:w-4/12 m-0 px-4 md:px-10 pt-8 pb-16 md:pb-20 lg:py-20">
						<div data-aos="fade-up" className="relative mx-auto">
							<ProductSearch />
							{action.text && <a href={`#${scroll_to}`} className="xl:hidden scroll-selector dark:bg-green-500 bg-green-600 relative rounded-full text-xl capitalize text-white ml-2 mr-4 mt-0 mb-8 md:my-4 px-8 lg:px-8 py-4 lg:py-4 transform hover:scale-65 select-none hover:select-none">
