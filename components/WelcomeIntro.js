		...
		<div id="intro-index" className="relative w-full h-auto xl:h-126 dark:bg-black bg-intro-index bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
			<div className="dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-800 w-full relative px-4 md:px-3 lg:px-9 flex flex-wrap xl:flex-nowrap justify-around xl:justify-start items-center bg-gradient-to-b dark:from-slate-900 from-white dark:bg-opacity-10 bg-opacity-30">
				<div data-aos="fade" className="relative upercase w-full xl:w-3/5 dark:text-slate-200 text-green-500 m-0 px-2 md:px-10 py-8 lg:pr-0 lg:p-10 xl:p-20">
					...
					{subtitle.text && <span className="block mt-4 dark:text-green-300 text-gray-600 text-2xl font-medium lg:text-3xl"> {subtitle.text} </span>}
				</div>
				<div className="relative xl:absolute xl:right-20 xl:top-0 w-full xl:w-4/12 m-0 px-4 md:px-10 pt-8 pb-16 md:pb-20 lg:py-20">
					<div data-aos="fade-up" className="relative mx-auto">
						<ProductSearch />
						{action.text && <a href={`#${scroll_to}`} className="xl:hidden scroll-selector dark:bg-opacity-50 dark:bg-green-500 bg-green-600 relative rounded-full text-2xl capitalize text-white ml-2 mr-4 mt-0 mb-8 md:my-4 px-8 lg:px-16 py-4 lg:py-6 transform hover:scale-65 select-none hover:select-none">
