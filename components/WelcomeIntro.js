    ...
    <div id="intro-index" className="relative w-full h-auto lg:h-188 bg-intro-index-dark bg-right-top md:bg-left-top bg-cover bg-scroll lg:bg-fixed bg-no-repeat">
      <div className="bg-algrith-green/80 dark:bg-slate-900/90 h-full w-full 2xl:w-8/12 mx-auto flex justify-between items-center px-6 md:px-13 lg:px-23 xl:px-33 py-16">
        <div data-aos="fade" className="relative w-full lg:w-3/5">
          ...
          {action.text && (
            <a href={`#${scroll_to}`} className="mt-10 md:mt-16 scroll-selector inline-flex items-center gap-4 bg-green-600 hover:bg-green-500 relative rounded-full text-xl capitalize text-white ml-2 px-8 py-4 select-none hover:select-none">
